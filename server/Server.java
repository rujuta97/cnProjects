                    ...
                    if(strarrivedarr[0].equals("dir")){
                        ...
                        if (strarrivedarr.length < 2) {
                            ...
                            if (!srcFile.exists()) {
                                ...
                                File destFile = new File("../client1/" + strarrivedarr[1]);
                        ...
                        if (strarrivedarr.length < 2) {
                            ...
                            File srcFile = new File("../client1/" + strarrivedarr[1]);
                            if (!srcFile.exists()) {
                                output.writeUTF("No such file exists.");
                            }
                            else {
                                File destFile = new File(strarrivedarr[1]);
                                String info = new String(Files.readAllBytes(Paths.get("../client1/" + strarrivedarr[1])));
                                Files.write(destFile.toPath(), info.getBytes(StandardCharsets.UTF_8), StandardOpenOption.CREATE);
